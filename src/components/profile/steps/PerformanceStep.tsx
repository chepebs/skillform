  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground">Share your achievements and performance data</p>
      </div>

      {/* Pitches Section */}
      <div className="space-y-4">
        <Label className="text-lg">Pitch Performance</Label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <Label>Pitches Participated</Label>
                <FormControl>
                  <Input
                    {...field}
                    type="number"
        ...
        <RatioDisplay won={pitchesWon} participated={pitchesParticipated} label="Pitch Win Ratio" />
      </div>

      {/* Brands Section */}
      <div className="space-y-4">
        <Label className="text-lg">Brand Work</Label>
      ...
      {/* Effie Section */}
      <div className="space-y-4">
        <Label className="text-lg">Effie Awards</Label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <Label>Effie Awards Participated</Label>
                <FormControl>
                  <Input
                    {...field}
                    type="number"
        ...
        <RatioDisplay won={effieWon} participated={effieParticipated} label="Effie Win Ratio" />
      </div>
    </div>
  );
};
