interface SkillFormIconProps {
  className?: string;
}

/**
 * Skill*form brand icon — person with sparkle.
 * Uses currentColor so it inherits text color (typically text-primary).
 */
export function SkillFormIcon({ className = "h-4 w-4" }: SkillFormIconProps) {
  return (
    <svg
